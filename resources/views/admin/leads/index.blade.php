    ...
    $(document).ready(function() {
        $('#leads-table').DataTable({
            ...
            "language": {
                ...
                "emptyTable": '<div class="text-center py-4"><div class="text-muted"><i class="fas fa-user-tie fa-2x mb-3 d-block"></i><p class="mb-0">No leads found</p><p class="small">{{ request()->hasAny(["status", "from_date", "to_date"]) ? "Try adjusting your filters" : "Get started by creating a new lead" }}</p></div></div>',
                "paginate": {
                    "first": "First",
                    "last": "Last",
                    "next": "Next",
