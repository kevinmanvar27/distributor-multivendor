                    ...
                    <a href="{{ route('store.products', ['slug' => $vendor->store_slug, 'category' => $category->id]) }}" class="text-decoration-none">
                        <div class="card border-0 shadow-sm h-100 category-card">
                            <div class="card-body text-center p-4">
                                @if($category->image)
                                    <img src="{{ $category->image->url }}" alt="{{ $category->name }}" class="rounded-circle mb-3" style="width: 80px; height: 80px; object-fit: cover;">
                                @else
    ...
    <div class="mb-5">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
                ...
                <p class="text-muted mb-0">{{ $vendor->store_description }}</p>
            </div>
        </div>
    </div>
    @endif
