            ...
            <div class="card coming-soon-card border-0">
                <div class="card-body text-center p-5">
                    ...
                    <div class="coming-soon-message">
                        @if($setting && $setting->coming_soon_message)
                            {!! nl2br(e(str_replace('{launch_time}', $setting->launch_time ? \Carbon\Carbon::parse($setting->launch_time)->format('d/m/Y H:i') : 'soon', $setting->coming_soon_message))) !!}
                        @else
                            <p>We're launching soon! Our amazing platform will be available at {{ $setting->launch_time ? \Carbon\Carbon::parse($setting->launch_time)->format('d/m/Y H:i') : 'soon' }}.</p>
                        @endif
                    </div>
