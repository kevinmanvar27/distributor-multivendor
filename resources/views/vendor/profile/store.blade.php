                            ...
                            <div class="card border-0 shadow-sm h-100">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="return_policy" name="return_policy" rows="3">{{ old('return_policy', $settings['return_policy'] ?? '') }}</textarea>
                                    </div>
                                    
                                    <div class="mb-3">
                                        <label for="shipping_policy" class="form-label fw-bold">Shipping Policy</label>
                                        <textarea class="form-control" id="shipping_policy" name="shipping_policy" rows="3">{{ old('shipping_policy', $settings['shipping_policy'] ?? '') }}</textarea>
                                    </div>
                                    
                                    <div class="mb-3">
                                        <label for="terms_conditions" class="form-label fw-bold">Terms & Conditions</label>
                                        <textarea class="form-control" id="terms_conditions" name="terms_conditions" rows="3">{{ old('terms_conditions', $settings['terms_conditions'] ?? '') }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
