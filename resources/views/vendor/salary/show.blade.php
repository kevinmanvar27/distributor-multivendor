                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <img src="{{ $user->avatar_url ?? asset('images/default-avatar.png') }}" class="rounded-circle" width="80" height="80" alt="{{ $user->name }}">
                            </div>
                            <div class="col">
                            ...
                            <div class="col-auto">
                                ...
                                <a href="{{ route('vendor.salary.index') }}" class="btn btn-outline-secondary rounded-pill px-4 ms-2">
