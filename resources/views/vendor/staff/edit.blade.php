                                            ...
                                            <div class="row">
                                                <div class="col-6 mb-2">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="permissions[]" value="products" id="perm_products" {{ in_array('products', old('permissions', $staffPermissions)) ? 'checked' : '' }}>
                                                ...
                                                <div class="col-6 mb-2">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="permissions[]" value="orders" id="perm_orders" {{ in_array('orders', old('permissions', $staffPermissions)) ? 'checked' : '' }}>
                                                ...
                                                <div class="col-6 mb-2">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="permissions[]" value="categories" id="perm_categories" {{ in_array('categories', old('permissions', $staffPermissions)) ? 'checked' : '' }}>
                                                ...
                                                <div class="col-6 mb-2">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="permissions[]" value="media" id="perm_media" {{ in_array('media', old('permissions', $staffPermissions)) ? 'checked' : '' }}>
                                                ...
                                                <div class="col-6 mb-2">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="permissions[]" value="leads" id="perm_leads" {{ in_array('leads', old('permissions', $staffPermissions)) ? 'checked' : '' }}>
                                                ...
                                                <div class="col-6 mb-2">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="permissions[]" value="coupons" id="perm_coupons" {{ in_array('coupons', old('permissions', $staffPermissions)) ? 'checked' : '' }}>
                                                ...
                                                <div class="col-6 mb-2">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="permissions[]" value="reports" id="perm_reports" {{ in_array('reports', old('permissions', $staffPermissions)) ? 'checked' : '' }}>
                                                ...
                                                <div class="col-6 mb-2">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="permissions[]" value="invoices" id="perm_invoices" {{ in_array('invoices', old('permissions', $staffPermissions)) ? 'checked' : '' }}>
