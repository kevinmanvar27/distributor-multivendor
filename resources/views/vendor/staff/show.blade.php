                            ...
                            <div class="col-lg-6">
                                ...
                                @php
                                    $allPermissions = [
                                        ...
                                        'categories' => ['icon' => 'fa-folder', 'label' => 'Categories'],
                                        'media' => ['icon' => 'fa-images', 'label' => 'Media'],
                                        'leads' => ['icon' => 'fa-user-plus', 'label' => 'Leads'],
                                        'coupons' => ['icon' => 'fa-ticket-alt', 'label' => 'Coupons'],
                                        ...
                                        @foreach($allPermissions as $key => $perm)
                                            <div class="col-6 mb-2">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    @endif
                                                    <i class="fas {{ $perm['icon'] }} me-2 text-muted"></i>
                                                    <span class="{{ in_array($key, $staffPermissions) ? '' : 'text-muted' }}">{{ $perm['label'] }}</span>
                                                </div>
                                            </div>
                                        @endforeach
                                    </div>
                                    ...
                                    <div class="border rounded-3 p-3">
                                        <div class="row text-center">
                                            ...
                                            <div class="col-4">
                                                ...
                                                <div class="fw-bold">{{ count($staffPermissions) }} / {{ count($allPermissions) }}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
