                                    ...
                                    <div class="row">
                                        <div class="col-lg-8">
                                            ...
                                            <div id="simple-product-fields" class="{{ old('product_type', 'simple') == 'simple' ? '' : 'd-none' }}">
                                                ...
                                                <div class="mb-4">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="in_stock" id="in_stock" value="1" {{ old('in_stock', true) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="card mb-4">
                                                ...
                                                <div class="card-body">
                                                    <input type="hidden" name="main_photo_id" id="main_photo_id" value="{{ old('main_photo_id') }}">
                                            ...
                                            <div class="card mb-4">
                                                ...
                                                <div class="card-body">
                                                    <input type="hidden" name="product_gallery" id="product_gallery" value="{{ old('product_gallery', '[]') }}">
...
<script>
    ...
    // Initialize gallery from old input
    $(document).ready(function() {
        try {
            const oldGallery = JSON.parse($('#product_gallery').val() || '[]');
    ...
    function selectMedia(id, url, name) {
        if (currentMediaTarget === 'main') {
            ...
            // Don't close modal for gallery - allow multiple selections
